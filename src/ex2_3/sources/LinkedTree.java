...
import ex2_3.sources.exceptions.NonEmptyTreeException;
...
public class LinkedTree<E> implements  Tree<E> {
	...
	// 3_ b) Com base no algoritmo posorder (slide 57) crie o método toStringPostorder (imprime os valores dos nodes visitados).
